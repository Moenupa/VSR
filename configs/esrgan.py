exp_name = 'esrgan_x4c64b23g32_g1_100k_stm3k'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='data/STM3k/train_frames/lq',
            gt_folder='data/STM3k/train_frames/gt',
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type=val_dataset_type,
        lq_folder='data/STM3k/val_frames/lq',
        gt_folder='data/STM3k/val_frames/gt',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    test=dict(
        type=val_dataset_type,
        lq_folder='data/STM3k/test_frames/lq',
        gt_folder='data/STM3k/test_frames/gt',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'))
